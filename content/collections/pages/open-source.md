...
I do [a lot of work in the open](https://noeldemartin.com/blog/open-productivity), and you'll be able to find most of the code I write [in my GitHub account](https://github.com/noelDeMartin) (I've got more than 200 repositories at this point!).

However, I don't pay the same level of attention to all the repositories. Some of them are throwaway projects, and some are libraries I've been working on for years. You should be able to guess which is which by reading the README file and looking at the commit count/history. However, as a rule of thumb, if a repository is listed [in my projects page](https://noeldemartin.com/projects) without the "experimental" or "archived" tags, you can count on it being maintained.
...
However, keep in mind that most of the work I do is _opinionated_. Which means that I'm not going to implement all the feature requests. Many times, I'll just add an "enhancement" badge and keep it open in case someone else wants to work on it. But unless something is a bug, I don't guarantee I'll tackle the request.
...
For any substantial feature, I strongly suggest that you open an issue validating your idea before you spend any time working on it. As I mentioned, most of my projects are _opinionated_, so I won't be accepting any feature even if it's technically correct.
