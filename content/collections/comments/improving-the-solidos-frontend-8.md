...
Anyhow, as part of migrating the header to the design system I also migrated `solid-panes` to Vite; and continue doing improvements to the tooling. For the last couple of weeks I have left, I think I'll probably focus on cleaning things up and leaving things as stable as possible.
