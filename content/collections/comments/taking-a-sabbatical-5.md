...
- Making my content more accessible.
    ...
    Going through this, I also experimented with hosting my own podcast and generating the RSS feed from scratch. It was easier than I expected, and I also learned about [RSS styles](https://www.rss.style/) which are pretty neat. If you're curious to listen to the episode, you can plug this in your favorite podcast app (or click to listen in the browser): <a href="https://noeldemartin.com/podcast/feed.xml" target="_blank">noeldemartin.com/podcast/feed.xml</a>.
