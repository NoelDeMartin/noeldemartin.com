...
- [Mastodon](https://github.com/noeldemartin/mastodon)
- [Nextcloud](https://github.com/NoelDeMartin/nextcloud)
- [noeldemartin.com](https://noeldemartin.com) (this site!)
- [proxy.noeldemartin.com](https://proxy.noeldemartin.com)
- [vocab.noeldemartin.com](https://vocab.noeldemartin.com)
- [LSS](https://github.com/noelDeMartin/lss) (a Laravel Solid Server that uses Nextcloud for Storage)
- [Rem](https://github.com/NoelDeMartin/rem) (I'm probably going to remove this)
- [Jazz Store](https://github.com/NoelDeMartin/jazz-store) (I'm also going to remove this)

And the tools I'm using to orchestrate and manage all of this are [kanjuro](https://github.com/NoelDeMartin/kanjuro) (docker), [rireki](https://github.com/noelDeMartin/rireki) (backups), and [nginx-agora](https://github.com/noelDeMartin/nginx-agora).
