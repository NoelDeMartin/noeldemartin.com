...
But things are diffrent now. I don't have a 4-day workweek anymore, which leaves me very little time for side projects. And to be honest, the whole [NLNet fiasco](https://noeldemartin.com/blog/the-soul-crushing-reality-of-job-seeking#the-nlnet-fiasco) and [subsequent developments](https://noeldemartin.social/%40noeldemartin/114745305327263276) have left me very unmotivated. So now, more than ever, I'm scratching my own itch. And I'm not sure that all this complexity is paying off. After all, I've been working on this for 6 years now, and I'm still only using my own apps (and I can't say I'm excited about any other Solid apps).
