...
@section('content')
    <article data-controller="code-highlighter">
        ...
        @if(!empty($post->landmarks))
            ...
            <div class="table-of-contents" data-controller="table-of-contents" data-turbolinks="false">
                ...
                <button
                    type="button"
                    class="table-of-contents--button group fixed top-0 mr-4 mt-4 w-12 h-12 flex items-center justify-center md:-mr-1 md:mt-16 md:w-8 md:h-8"
