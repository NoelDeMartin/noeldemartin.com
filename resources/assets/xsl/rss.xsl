            ...
            <body class="bg-gray-50">
                <div class="max-w-prose px-6 py-8 mx-auto">
                    <div class="flex items-center">
                        ...
                        <h1 class="ml-2 font-semibold text-3xl"><xsl:value-of select="title"/></h1>
                    </div>
                    ...
                    <div class="space-y-4 pt-2">
                        <xsl:for-each select="item">
                            <div class="bg-white border px-8 py-4 rounded">
                                <h2 class="font-semibold text-xl"><xsl:value-of select="title"/></h2>
                                <audio class="mt-4">
                    ...
                    <hr class="mt-2"></hr>
                    <p class="mt-2">Use the following url to listen in your favourite podcast app:</p>
                    <pre class="mt-2 bg-gray-200 p-2 rounded">
